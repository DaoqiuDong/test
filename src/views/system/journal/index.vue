        ...
        <div class="dark">
            ...
            <div class="data-container">
                <el-table v-loading="loading" :data="list"
                    ...
                    <el-table-column label="操作内容" prop="actionName" align="center" />
...
<script>
    import {listOprJournal} from "@/api/journal";
    export default {
        name: "OprJournal",
        data() {
            return {
        ...
        methods:{
            getList(){
                this.loading = true
                listOprJournal(this.queryParams).then(response=>{
                    this.loading = false
                    this.list = response.data.list;
                    this.total = response.data.total;
                    if(this.list){
                        this.list.forEach(i => {
                            i.actionName=this.actions[i.action]
                        })
                    }
                    /*if(this.list){
                        this.list.forEach(i => {
