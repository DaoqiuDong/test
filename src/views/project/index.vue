            ...
            <div class="condition big-form">
                <el-form :model="queryParams" :inline="true" label-width="9rem">
                    ...
                    <el-form-item>
                        ...
                        <el-button type="success"  @click="handleExport" v-hasPermi="['project:project:export']">导出</el-button>
...
<script>
    import {getList,getExportList} from '@/api/project'
    ...
    export default {
        ...
        methods: {
            ...
            handleExport() {
                getExportList(this.queryParams).then(response =>{
            ...
            exportExcel(){
                ...
                if(this.exportList){
                    this.exportList.forEach(i => {
                        ...
                        // const s= this.statusList.find(c => c.dictValue === i.status)
                        // if(s){
