                    ...
                    <el-form :model="queryParams" :inline="true" label-width="9rem">
                            ...
                            <el-row>
                                ...
                                <el-col :span="8">
                                    <el-form-item label="项目状态">
                                        <el-select v-model="queryParams.status" placeholder="已审批" disabled >
                                            <el-option
                        ...
                        <div class="bohotec-button-project">
                            <el-form-item>
                                ...
                                <el-button type="success"  @click="handleExport" v-hasPermi="['project:approved:export']">导出</el-button>
...
<script>
    import {getApprovedList,getApprovedExportList} from '@/api/project'
    ...
    export default {
        ...
        methods: {
            getList() {
                this.loading = true
                getApprovedList(this.queryParams).then(res => {
                    console.log('res=',res)
            ...
            /** 导出按钮操作 */
            handleExport() {
                getApprovedExportList(this.queryParams).then(response =>{
            ...
            exportExcel(){
                ...
                /* save to file */
                XLSX.writeFile(wb, '项目管理已审批报表.xlsx');
            },
            clearParams(){
                this.queryParams = {
                    pageNum: 1,
